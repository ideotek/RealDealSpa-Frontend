                  ...
                  {bookingHistory.map((booking) => (
                    <div 
                      ...
                      className={viewMode === 'grid' ? 
                        "p-6 bg-white hover:shadow-lg rounded transition-all border border-gray-100 transform hover:-translate-y-1" : 
                        "p-5 bg-white hover:shadow-md rounded transition-all border border-gray-100"
                      }
                    >
                      <div className={viewMode === 'grid' ? "flex flex-col h-full justify-between" : "flex items-center justify-between"}>
                        ...
                        <div className={viewMode === 'grid' ? "mt-4 space-y-2" : "ml-4 space-x-2"}>
