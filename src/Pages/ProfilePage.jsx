          ...
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <button 
                  className="flex flex-col items-center p-4 bg-gray-50 rounded-lg text-sm text-gray-700 hover:bg-gray-100 transition-colors"
                  onClick={() => setIsModalOpen(true)}
                >
                  <div className="w-10 h-10 bg-red-50 rounded-lg flex items-center justify-center text-xl mb-2">
                    🔒
                  </div>
                  ...
                  {purchaseHistory.length > 0 ? (
                    <div className="space-y-3">
                      {purchaseHistory.map((purchase) => (
                        <div
                          key={purchase.id}
                          className="p-4 hover:bg-red-50 rounded-lg transition-colors"
                        >
